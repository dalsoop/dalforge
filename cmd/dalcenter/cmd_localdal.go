...
func newServeCmd() *cobra.Command {
	var addr, serviceRepo, bridgeURL, dalbridgeURL, bridgeConf, githubRepo string
	cmd := &cobra.Command{
		Use:   "serve",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			d := daemon.New(addr, root, serviceRepo, bridgeURL, dalbridgeURL, bridgeConf, githubRepo)
